...
module.exports = {
    ...
    cooldown: 10,
    isSewa: true,
    isBlockCmd: checkDataId("blockcmd", "awoo", db.data), 
    isOwner: checkDataId("owner", "awoo", db.data), 
    isPremium: checkDataId("premium", "awoo", db.data),
    isLimit: checkDataId("limit", "awoo", db.data),
    isWait: true, 
    callback: async (sock, m, { prefix, command, setQuoted }) => {
        var { data } = await axios.get("https://waifu.pics/api/sfw/awoo")
