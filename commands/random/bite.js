...
module.exports = {
    ...
    cooldown: 10,
    isSewa: true,
    isBlockCmd: checkDataId("blockcmd", "bite", db.data), 
    isOwner: checkDataId("owner", "bite", db.data), 
    isPremium: checkDataId("premium", "bite", db.data),
    isLimit: checkDataId("limit", "bite", db.data),
    isWait: true, 
    callback: async (sock, m, { prefix, command, setQuoted }) => {
        var { data } = await axios.get("https://waifu.pics/api/sfw/bite")
