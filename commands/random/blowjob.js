...
module.exports = {
    ...
    cooldown: 10,
    isSewa: true,
    isBlockCmd: checkDataId("blockcmd", "blowjob", db.data), 
    isOwner: checkDataId("owner", "blowjob", db.data), 
    isPremium: checkDataId("premium", "blowjob", db.data),
    isLimit: checkDataId("limit", "blowjob", db.data),
    isWait: true, 
    callback: async (sock, m, { prefix, command, setQuoted }) => {
        var { data } = await axios.get("https://waifu.pics/api/nsfw/blowjob")
