...
module.exports = {
    ...
    cooldown: 10,
    isSewa: true,
    isBlockCmd: checkDataId("blockcmd", "bonk", db.data), 
    isOwner: checkDataId("owner", "bonk", db.data), 
    isPremium: checkDataId("premium", "bonk", db.data),
    isLimit: checkDataId("limit", "bonk", db.data),
    isWait: true, 
    callback: async (sock, m, { prefix, command, setQuoted }) => {
        var { data } = await axios.get("https://waifu.pics/api/sfw/bonk")
