...
module.exports = {
    ...
    cooldown: 10,
    isSewa: true,
    isBlockCmd: checkDataId("blockcmd", "boobs", db.data), 
    isOwner: checkDataId("owner", "boobs", db.data), 
    isPremium: checkDataId("premium", "boobs", db.data),
    isLimit: checkDataId("limit", "boobs", db.data),
    isWait: true, 
    callback: async (sock, m, { prefix, command, setQuoted }) => {
        var { data } = await axios.get("https://anime-api.hisoka17.repl.co/img/nsfw/boobs")
