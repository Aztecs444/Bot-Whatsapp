...
module.exports = {
    ...
    cooldown: 10,
    isSewa: true,
    isBlockCmd: checkDataId("blockcmd", "cringe", db.data), 
    isOwner: checkDataId("owner", "cringe", db.data), 
    isPremium: checkDataId("premium", "cringe", db.data),
    isLimit: checkDataId("limit", "cringe", db.data),
    isWait: true, 
    callback: async (sock, m, { prefix, command, setQuoted }) => {
        var { data } = await axios.get("https://waifu.pics/api/sfw/cringe")
