...
module.exports = {
    ...
    cooldown: 10,
    isSewa: true,
    isBlockCmd: checkDataId("blockcmd", "cry", db.data), 
    isOwner: checkDataId("owner", "cry", db.data), 
    isPremium: checkDataId("premium", "cry", db.data),
    isLimit: checkDataId("limit", "cry", db.data),
    isWait: true, 
    callback: async (sock, m, { prefix, command, setQuoted }) => {
        var { data } = await axios.get("https://waifu.pics/api/sfw/cry")
