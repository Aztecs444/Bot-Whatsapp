...
module.exports = {
    ...
    cooldown: 10,
    isSewa: true,
    isBlockCmd: checkDataId("blockcmd", "cuddle", db.data), 
    isOwner: checkDataId("owner", "cuddle", db.data), 
    isPremium: checkDataId("premium", "cuddle", db.data),
    isLimit: checkDataId("limit", "cuddle", db.data),
    isWait: true, 
    callback: async (sock, m, { prefix, command, setQuoted }) => {
        var { data } = await axios.get("https://anime-api.hisoka17.repl.co/img/cuddle")
