...
module.exports = {
    ...
    cooldown: 10,
    isSewa: true,
    isBlockCmd: checkDataId("blockcmd", "cuddle2", db.data), 
    isOwner: checkDataId("owner", "cuddle2", db.data), 
    isPremium: checkDataId("premium", "cuddle2", db.data),
    isLimit: checkDataId("limit", "cuddle2", db.data),
    isWait: true, 
    callback: async (sock, m, { prefix, command, setQuoted }) => {
        var { data } = await axios.get("https://waifu.pics/api/sfw/cuddle")
