...
module.exports = {
    ...
    cooldown: 10,
    isSewa: true,
    isBlockCmd: checkDataId("blockcmd", "dance", db.data), 
    isOwner: checkDataId("owner", "dance", db.data), 
    isPremium: checkDataId("premium", "dance", db.data),
    isLimit: checkDataId("limit", "dance", db.data),
    isWait: true, 
    callback: async (sock, m, { prefix, command, setQuoted }) => {
        var { data } = await axios.get("https://waifu.pics/api/sfw/dance")
