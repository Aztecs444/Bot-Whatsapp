...
module.exports = {
    ...
    cooldown: 10,
    isSewa: true,
    isBlockCmd: checkDataId("blockcmd", "glomp", db.data), 
    isOwner: checkDataId("owner", "glomp", db.data), 
    isPremium: checkDataId("premium", "glomp", db.data),
    isLimit: checkDataId("limit", "glomp", db.data),
    isWait: true, 
    callback: async (sock, m, { prefix, command, setQuoted }) => {
        var { data } = await axios.get("https://waifu.pics/api/sfw/glomp")
