...
module.exports = {
    ...
    cooldown: 10,
    isSewa: true,
    isBlockCmd: checkDataId("blockcmd", "happy", db.data), 
    isOwner: checkDataId("owner", "happy", db.data), 
    isPremium: checkDataId("premium", "happy", db.data),
    isLimit: checkDataId("limit", "happy", db.data),
    isWait: true, 
    callback: async (sock, m, { prefix, command, setQuoted }) => {
        var { data } = await axios.get("https://waifu.pics/api/sfw/happy")
