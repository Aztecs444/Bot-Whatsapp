...
module.exports = {
    ...
    cooldown: 10,
    isSewa: true,
    isBlockCmd: checkDataId("blockcmd", "hentai", db.data), 
    isOwner: checkDataId("owner", "hentai", db.data), 
    isPremium: checkDataId("premium", "hentai", db.data),
    isLimit: checkDataId("limit", "hentai", db.data),
    isWait: true, 
    callback: async (sock, m, { prefix, command, setQuoted }) => {
        var { data } = await axios.get("https://anime-api.hisoka17.repl.co/img/nsfw/hentai")
