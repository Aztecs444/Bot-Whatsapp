...
module.exports = {
    ...
    cooldown: 10,
    isSewa: true,
    isBlockCmd: checkDataId("blockcmd", "hug", db.data), 
    isOwner: checkDataId("owner", "hug", db.data), 
    isPremium: checkDataId("premium", "hug", db.data),
    isLimit: checkDataId("limit", "hug", db.data),
    isWait: true, 
    callback: async (sock, m, { prefix, command, setQuoted }) => {
        var { data } = await axios.get("https://anime-api.hisoka17.repl.co/img/hug")
