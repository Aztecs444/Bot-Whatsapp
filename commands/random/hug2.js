...
module.exports = {
    ...
    cooldown: 10,
    isSewa: true,
    isBlockCmd: checkDataId("blockcmd", "hug2", db.data), 
    isOwner: checkDataId("owner", "hug2", db.data), 
    isPremium: checkDataId("premium", "hug2", db.data),
    isLimit: checkDataId("limit", "hug2", db.data),
    isWait: true, 
    callback: async (sock, m, { prefix, command, setQuoted }) => {
        var { data } = await axios.get("https://waifu.pics/api/sfw/hug")
