...
module.exports = {
    ...
    cooldown: 10,
    isSewa: true,
    isBlockCmd: checkDataId("blockcmd", "kiss", db.data), 
    isOwner: checkDataId("owner", "kiss", db.data), 
    isPremium: checkDataId("premium", "kiss", db.data),
    isLimit: checkDataId("limit", "kiss", db.data),
    isWait: true, 
    callback: async (sock, m, { prefix, command, setQuoted }) => {
        var { data } = await axios.get("https://anime-api.hisoka17.repl.co/img/kiss")
