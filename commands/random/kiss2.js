...
module.exports = {
    ...
    cooldown: 10,
    isSewa: true,
    isBlockCmd: checkDataId("blockcmd", "kiss2", db.data), 
    isOwner: checkDataId("owner", "kiss2", db.data), 
    isPremium: checkDataId("premium", "kiss2", db.data),
    isLimit: checkDataId("limit", "kiss2", db.data),
    isWait: true, 
    callback: async (sock, m, { prefix, command, setQuoted }) => {
        var { data } = await axios.get("https://waifu.pics/api/sfw/kiss")
