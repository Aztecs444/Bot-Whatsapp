...
module.exports = {
    ...
    cooldown: 10,
    isSewa: true,
    isBlockCmd: checkDataId("blockcmd", "lesbian", db.data), 
    isOwner: checkDataId("owner", "lesbian", db.data), 
    isPremium: checkDataId("premium", "lesbian", db.data),
    isLimit: checkDataId("limit", "lesbian", db.data),
    isWait: true, 
    callback: async (sock, m, { prefix, command, setQuoted }) => {
        var { data } = await axios.get("https://anime-api.hisoka17.repl.co/img/nsfw/lesbian")
