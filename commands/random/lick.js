...
module.exports = {
    ...
    cooldown: 10,
    isSewa: true,
    isBlockCmd: checkDataId("blockcmd", "lick", db.data), 
    isOwner: checkDataId("owner", "lick", db.data), 
    isPremium: checkDataId("premium", "lick", db.data),
    isLimit: checkDataId("limit", "lick", db.data),
    isWait: true, 
    callback: async (sock, m, { prefix, command, setQuoted }) => {
        var { data } = await axios.get("https://waifu.pics/api/sfw/lick")
