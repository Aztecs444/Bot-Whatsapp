...
module.exports = {
    ...
    cooldown: 10,
    isSewa: true,
    isBlockCmd: checkDataId("blockcmd", "megumin", db.data), 
    isOwner: checkDataId("owner", "megumin", db.data), 
    isPremium: checkDataId("premium", "megumin", db.data),
    isLimit: checkDataId("limit", "megumin", db.data),
    isWait: true, 
    callback: async (sock, m, { prefix, command, setQuoted }) => {
        var { data } = await axios.get("https://waifu.pics/api/sfw/megumin")
