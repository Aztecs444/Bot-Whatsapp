...
module.exports = {
    ...
    cooldown: 10,
    isSewa: true,
    isBlockCmd: checkDataId("blockcmd", "neko", db.data), 
    isOwner: checkDataId("owner", "neko", db.data), 
    isPremium: checkDataId("premium", "neko", db.data),
    isLimit: checkDataId("limit", "neko", db.data),
    isWait: true, 
    callback: async (sock, m, { prefix, command, setQuoted }) => {
        var { data } = await axios.get("https://waifu.pics/api/sfw/neko")
