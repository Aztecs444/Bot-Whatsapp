...
module.exports = {
    ...
    cooldown: 10,
    isSewa: true,
    isBlockCmd: checkDataId("blockcmd", "neko2", db.data), 
    isOwner: checkDataId("owner", "neko2", db.data), 
    isPremium: checkDataId("premium", "neko2", db.data),
    isLimit: checkDataId("limit", "neko2", db.data),
    isWait: true, 
    callback: async (sock, m, { prefix, command, setQuoted }) => {
        var { data } = await axios.get("https://waifu.pics/api/nsfw/neko")
