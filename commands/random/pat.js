...
module.exports = {
    ...
    cooldown: 10,
    isSewa: true,
    isBlockCmd: checkDataId("blockcmd", "pat", db.data), 
    isOwner: checkDataId("owner", "pat", db.data), 
    isPremium: checkDataId("premium", "pat", db.data),
    isLimit: checkDataId("limit", "pat", db.data),
    isWait: true, 
    callback: async (sock, m, { prefix, command, setQuoted }) => {
        var { data } = await axios.get("https://anime-api.hisoka17.repl.co/img/pat")
