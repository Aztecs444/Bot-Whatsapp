...
module.exports = {
    ...
    cooldown: 10,
    isSewa: true,
    isBlockCmd: checkDataId("blockcmd", "pat2", db.data), 
    isOwner: checkDataId("owner", "pat2", db.data), 
    isPremium: checkDataId("premium", "pat2", db.data),
    isLimit: checkDataId("limit", "pat2", db.data),
    isWait: true, 
    callback: async (sock, m, { prefix, command, setQuoted }) => {
        var { data } = await axios.get("https://waifu.pics/api/sfw/pat")
