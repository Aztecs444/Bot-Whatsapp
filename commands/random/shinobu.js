...
module.exports = {
    ...
    cooldown: 10,
    isSewa: true,
    isBlockCmd: checkDataId("blockcmd", "shinobu", db.data), 
    isOwner: checkDataId("owner", "shinobu", db.data), 
    isPremium: checkDataId("premium", "shinobu", db.data),
    isLimit: checkDataId("limit", "shinobu", db.data),
    isWait: true, 
    callback: async (sock, m, { prefix, command, setQuoted }) => {
        var { data } = await axios.get("https://waifu.pics/api/sfw/shinobu")
