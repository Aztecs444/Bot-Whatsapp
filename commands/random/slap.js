...
module.exports = {
    ...
    cooldown: 10,
    isSewa: true,
    isBlockCmd: checkDataId("blockcmd", "slap", db.data), 
    isOwner: checkDataId("owner", "slap", db.data), 
    isPremium: checkDataId("premium", "slap", db.data),
    isLimit: checkDataId("limit", "slap", db.data),
    isWait: true, 
    callback: async (sock, m, { prefix, command, setQuoted }) => {
        var { data } = await axios.get("https://anime-api.hisoka17.repl.co/img/slap")
