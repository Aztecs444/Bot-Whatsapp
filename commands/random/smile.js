...
module.exports = {
    ...
    cooldown: 10,
    isSewa: true,
    isBlockCmd: checkDataId("blockcmd", "smile", db.data), 
    isOwner: checkDataId("owner", "smile", db.data), 
    isPremium: checkDataId("premium", "smile", db.data),
    isLimit: checkDataId("limit", "smile", db.data),
    isWait: true, 
    callback: async (sock, m, { prefix, command, setQuoted }) => {
        var { data } = await axios.get("https://waifu.pics/api/sfw/smile")
