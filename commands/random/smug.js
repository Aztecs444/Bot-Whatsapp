...
module.exports = {
    ...
    cooldown: 10,
    isSewa: true,
    isBlockCmd: checkDataId("blockcmd", "smug", db.data), 
    isOwner: checkDataId("owner", "smug", db.data), 
    isPremium: checkDataId("premium", "smug", db.data),
    isLimit: checkDataId("limit", "smug", db.data),
    isWait: true, 
    callback: async (sock, m, { prefix, command, setQuoted }) => {
        var { data } = await axios.get("https://waifu.pics/api/sfw/smug")
