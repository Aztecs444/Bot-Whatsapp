...
module.exports = {
    ...
    cooldown: 10,
    isSewa: true,
    isBlockCmd: checkDataId("blockcmd", "waifu", db.data), 
    isOwner: checkDataId("owner", "waifu", db.data), 
    isPremium: checkDataId("premium", "waifu", db.data),
    isLimit: checkDataId("limit", "waifu", db.data),
    isWait: true, 
    callback: async (sock, m, { prefix, command, setQuoted }) => {
        var { data } = await axios.get("https://anime-api.hisoka17.repl.co/img/waifu")
