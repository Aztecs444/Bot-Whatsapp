...
module.exports = {
    ...
    cooldown: 10,
    isSewa: true,
    isBlockCmd: checkDataId("blockcmd", "waifu2", db.data), 
    isOwner: checkDataId("owner", "waifu2", db.data), 
    isPremium: checkDataId("premium", "waifu2", db.data),
    isLimit: checkDataId("limit", "waifu2", db.data),
    isWait: true, 
    callback: async (sock, m, { prefix, command, setQuoted }) => {
        var { data } = await axios.get("https://waifu.pics/api/sfw/waifu")
