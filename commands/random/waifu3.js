...
module.exports = {
    ...
    cooldown: 10,
    isSewa: true,
    isBlockCmd: checkDataId("blockcmd", "waifu3", db.data), 
    isOwner: checkDataId("owner", "waifu3", db.data), 
    isPremium: checkDataId("premium", "waifu3", db.data),
    isLimit: checkDataId("limit", "waifu3", db.data),
    isWait: true, 
    callback: async (sock, m, { prefix, command, setQuoted }) => {
        var { data } = await axios.get("https://waifu.pics/api/nsfw/waifu")
