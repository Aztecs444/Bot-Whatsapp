...
module.exports = {
    ...
    cooldown: 10,
    isSewa: true,
    isBlockCmd: checkDataId("blockcmd", "wink", db.data), 
    isOwner: checkDataId("owner", "wink", db.data), 
    isPremium: checkDataId("premium", "wink", db.data),
    isLimit: checkDataId("limit", "wink", db.data),
    isWait: true, 
    callback: async (sock, m, { prefix, command, setQuoted }) => {
        var { data } = await axios.get("https://anime-api.hisoka17.repl.co/img/wink")
