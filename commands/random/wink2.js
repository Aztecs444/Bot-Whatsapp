...
module.exports = {
    ...
    cooldown: 10,
    isSewa: true,
    isBlockCmd: checkDataId("blockcmd", "wink2", db.data), 
    isOwner: checkDataId("owner", "wink2", db.data), 
    isPremium: checkDataId("premium", "wink2", db.data),
    isLimit: checkDataId("limit", "wink2", db.data),
    isWait: true, 
    callback: async (sock, m, { prefix, command, setQuoted }) => {
        var { data } = await axios.get("https://waifu.pics/api/sfw/wink")
