...
module.exports = {
    ...
    cooldown: 10,
    isSewa: true,
    isBlockCmd: checkDataId("blockcmd", "yeet", db.data), 
    isOwner: checkDataId("owner", "yeet", db.data), 
    isPremium: checkDataId("premium", "yeet", db.data),
    isLimit: checkDataId("limit", "yeet", db.data),
    isWait: true, 
    callback: async (sock, m, { prefix, command, setQuoted }) => {
        var { data } = await axios.get("https://waifu.pics/api/sfw/yeet")
